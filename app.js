...
var Ethan = new Student('Ethan', 'Green');


var Tyler = new Student('Tyler', 'Blue');


var Scott = new Student('Scott', 'Salmon');
...
/**
  ...
  */
var studentArray = [Ethan, Tyler, Scott];
